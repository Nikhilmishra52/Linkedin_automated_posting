...
def post_to_feed(driver,file_to_post):
    try:
        ...
        file_input=WebDriverWait(driver,60).until(
            EC.element_to_be_clickable((By.XPATH,"/html/body/div[3]/div/div/div/div[2]/div/div/div[1]/div/div[2]/input"))
        )
        file_input.send_keys(file_to_post)

        next_btn=WebDriverWait(driver,60).until(
            EC.element_to_be_clickable((By.XPATH,"/html/body/div[3]/div/div/div/div[2]/div/div/div[2]/div/button[2]"))
        )
        next_btn.click()
        time.sleep(3)
